...
namespace SignalR.Hub
{
    public class ChatHub : Microsoft.AspNetCore.SignalR.Hub
    {
        ...
        public async Task SendMessage(string name, string text)
        {
            ...
            await Clients.Group(roomId.ToString()).SendAsync("ReceiveMessage", message.SenderName, message.SendAt, message.TextMessage);
        }
        ...
        public async Task SetName(string visitorName)
        {
            ...
            await _chatRoomService.SetNameForRoom(roomId, roomName);
